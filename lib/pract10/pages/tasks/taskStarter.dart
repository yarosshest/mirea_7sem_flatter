...
import 'package:mirea_7sem_flatter/pract10/pages/tasks/task_Inherited_widget.dart';
import 'package:mirea_7sem_flatter/pract10/pages/tasks/task_add.dart';
  ...
  Future<void> _loadTasks() async {
    ...
    setState(() {
      if (newTasks!.isNotEmpty) {
        _tasks.addAll(newTasks as Iterable<Task>);
        _page++;
      } else {
        _hasMoreTasks = false;
      }
